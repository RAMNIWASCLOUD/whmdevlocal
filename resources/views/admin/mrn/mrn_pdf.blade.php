...
<table width="780px" border="0" cellspacing="0" cellpadding="0" style="font-size:8px; font-family:Arial, Helvetica, sans-serif; margin:0 auto; border:1px solid #000">
  <tr>
    <td style="border-bottom:1px solid #000"><table width="100%" border="0" cellspacing="0" cellpadding="5">
      <tr>
        <td align="center" style="font-size:14px"><strong>Material Request Note (MRN)</strong></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        ...
        <td style="border:1px solid #000; border-width:0 1px 1px 0">{{$data['mrn_ref']}}</td>
        <td style="border:1px solid #000; border-width:0 1px 1px 0">&nbsp;</td>
        <td style="border:1px solid #000; border-width:0 1px 1px 0">&nbsp;</td>
        <td style="border:1px solid #000; border-width:0 1px 1px 0">&nbsp;</td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        <td align="center" style="border:1px solid #000; border-width:0 1px 1px 0">1</td>
      ...
      <tr>
        <td align="center" style="border:1px solid #000; border-width:0 1px 1px 0">2</td>
