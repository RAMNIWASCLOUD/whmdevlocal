...
@section('content')
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
                  <a href="{{url('/')}}/add_vm_mrn" class="btn btn-primary btn-xs" style="float: right;">Add {{$title}}</a>
            </div>
            <!-- /.box-header -->
  ...
  <script type="text/javascript">
    function function_check_is_mrn_associated()
    {
      alert("The current logged in user does not have administrative privileges to perform this activity.");
    }
