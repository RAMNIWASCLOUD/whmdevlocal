  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('/')}}/new_swh_mrn">New {{ $title }}</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ url('/')}}/store_swh_mrn" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No." data-parsley-minlength="10" data-parsley-maxlength="10" data-parsley-minlength-message="Mobile No. should be 10 digit." data-parsley-maxlength-message="Mobile No. should be 10 digit." required="true">
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="location" name="location" placeholder="Location" value="{{\Session::get('state')}}" required="true">
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
