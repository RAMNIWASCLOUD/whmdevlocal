        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form action="{{ url('/')}}/update_{{$url_slug}}" method="post" role="form" data-parsley-validate="parsley">
              ...
              {!! csrf_field() !!}
               ...
               <div class="box-body">
                <div class="form-group">
                  <label for="oldpassword">Email(Username)</label>: <span>{{$data['username']}}</span>
                </div>
              </div>
              <div class="box-body">
                <div class="form-group">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="oldpassword">Warehouse Name</label>: <span>{{$data['warehouse_name']}}</span>
                </div>
              </div>
              <div class="box-body">
                <div class="form-group">
                  <label for="oldpassword">State</label>: <span>{{$data['state']}}</span>
                </div>
              </div>
             {{--  <div class="box-body">
                <div class="form-group">
                  <label for="oldpassword">Warehouse Address</label>: <span>{{$data['warehouse_address']}}</span>
                </div>
              </div> --}}
              <!-- /.box-body -->
