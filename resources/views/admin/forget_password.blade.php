...
<div class="login-box">
  <div class="login-logo">
     <img src="/css_and_js/logo.png">
    <a href="{{ url('/')}}/css_and_js/admin/index2.html"></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="{{ url('/')}}/forget_password_process" method="post" data-parsley-validate="parsley">
       {!! csrf_field() !!}
      <div class="form-group has-feedback">
        <input type="email" name="email" class="form-control" placeholder="Email" data-parsley-type="email" required="true">
