...
@section('content')
                  ...
                  <tbody>
                    ...
                    @foreach($data as $value)
                      <tr>
                        ...
                        <td>
                          {{$value['vmwh_dl_ch_ref']}}
                        </td>
                        <td>
                          {{$value['vmwh_dispatch_processing_date']}} & {{$value['vmwh_dispatch_processing_time']}}
                        </td>
                        <td>
                          {{$value['dispatch_mode']}}
                        </td>
                        ...
                        <td>
                          @if($value['vmwh_delivery_status']=='Delivered')
                            <center>{{$value['vmwh_delivery_date']}} & {{$value['vmwh_delivery_time']}}</center>
                          @else
                            <center>-</center>
                          @endif
                        </td>
                        <td>
                          ...
                          <td>
                          <a href="{{url('/')}}/vmwh_view_grn_{{$url_slug}}/{{$value['_id']}}" title="GRN" target="_blank"><i class="fa fa-file-pdf-o" style="color: red;"></i></a>
                          
                        </td>
                          <td>
                            <center>
                              <a href="{{url('/')}}/vmwh_view_{{$url_slug}}/{{$value['_id']}}" title="View" target="_blank"><i class="fa fa-file-pdf-o" style="color: red;"></i></a>
                            </center>
                        </td>
                      </tr>
                    <?php $i++; ?>
  ...
  <!-- /.content-wrapper --><div class="modal fade" id="modal-default">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{ url('/')}}/store_accept_dispatch_vmwh" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              @include('admin.layout._status_msg')
              {!! csrf_field() !!}
