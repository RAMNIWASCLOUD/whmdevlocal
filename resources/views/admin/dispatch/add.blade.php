  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('/')}}/edf_meter_pool">EDF Meter Pool</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ url('/')}}/form_dispatch_meter_step_2" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="oldpassword">MRN No.</label>: <span>{{ $mrn_details['mrn_ref'] }}</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="oldpassword">Total Uploaded Meter</label>: <span>{{$total_upload_meter}}</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body" >
                    <div class="form-group">
                      <label for="oldpassword">Match Found Meter</label>: <span>{{$match_found_meter}}</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <table id="example5" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php $modem_total=$i=1;$modem_data=[]; ?>
                        @if($modem_total!=0)
                ...
                <div class="col-md-4">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <select id="to_dispatch" name="to_dispatch" class="form-control" required="">
