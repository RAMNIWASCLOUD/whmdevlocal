    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            <td width="58%" style="border:1px solid #000; border-width:0 1px 1px 0"><strong>DN/Challan No: {{$data['dl_ch_ref']}}</strong></td>
            <td width="15%" style="border:1px solid #000; border-width:0 1px 1px 0"><strong>MRN NO:</strong></td>
            <td width="27%" style="border-bottom:1px solid #000"> {{$data['mrn_ref']}}</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <td width="42%" style="border:1px solid #000; border-width:0 1px 1px 0"><strong>{{$data['dispatch_processing_date']}}</strong></td>
