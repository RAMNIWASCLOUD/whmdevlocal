      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <form method="GET" action="" data-parsley-validate="parsley">
              ...
              <div class="row">
                  ...
                  <div class="box-body">
                    <div class="form-group1" >
                      <select class="form-control" id="filter" name="filter">
                        <option value="All Meter" @if((isset($_GET['filter']) && $_GET['filter']=='All Meter') || !empty($_GET['filter'])) selected @endif>All Meter</option>
                        <option value="S2S Repaired" @if(isset($_GET['filter']) && $_GET['filter']=='S2S Repaired') selected @endif>S2S Repaired</option>
                        <option value="Non-S2S Repaired" @if(isset($_GET['filter']) && $_GET['filter']=='Non-S2S Repaired') selected @endif)>Non-S2S Repaired</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-1">
                  <div class="box-body">
                    <div class="form-group" >
                      @if(Session::get('download_enabled')=='1')<a class="btn btn-primary" href="{{url('/').'/export_report/edf_meter_pool'}}">Export(.csv)</a>@endif
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
            ...
            <form id="form_dispatch_meter_step_1" action="{{url('/')}}/form_dispatch_meter_step_1" method="POST" enctype='multipart/form-data' data-parsley-validate="parsley">
              {!! csrf_field() !!}
            <div class="row">
                <div class="col-md-2">
                  <div class="box-body">
                    ...
                    <div class="form-group" >
                      ...
                      <select class="form-control" id="mrn" name="mrn">
                        ...
                        @foreach($mrn as $value)
                          <option value="{{$value['_id']}}">{{$value['mrn_ref']}}</option>
                        @endforeach
                      </select>
                ...
                <tbody>
                  ...
                  @foreach($data as $value)
                    <tr>
                      ...
                      <td>
                        {{(!empty($value['s2s_damaged_status']))? $value['s2s_damaged_status']:'-'}}
                      </td>
                      <td>
