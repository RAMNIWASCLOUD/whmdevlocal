    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
             <form action="{{ url('/')}}/s2s_upload_swh_accept_damaged_meter" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              {!! csrf_field() !!}
                <div class="row">
                  <div class="col-md-4">
                    <div class="box-body">
                      <div class="form-group">
                        <label for="oldpassword">Upload Accept Meter(.csv)<span style="color:red;" >*</span></label><a href="{{url('/')}}/sample_files/file_input/s2s_damage/sm_accept_s2s_damaged_meter.csv" target="_blank">Download Sample File</a>
            ...
            <form method="GET" action="" data-parsley-validate="parsley">
                ...
                <div class="col-md-1">
                  <div class="box-body">
                    <div class="form-group" >
                      @if(Session::get('download_enabled')=='1')<a style="margin-top: 23px" class="btn btn-primary" href="{{url('/').'/export_report/s2s_vm_to_sm_damaged_meter'}}">Export(.csv)</a>@endif
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="box-body">
                    <div class="form-group" style="float: right;margin-top: 23px">
                      <b>Per Page</b>
                ...
                <tbody>
                  ...
                  @foreach($data as $value)
                    <tr>
                      ...
                      <td>
                        <?php $user = \DB::table('login_users')->where(['_id'=>new MongoId($value['s2s_damaged_mark_by_id'])])->first(); ?>
                        {{$user['warehouse_name']}}
                      </td>
                      <td>
                        {{$value['s2s_damaged_mark_by_time']}}
                      </td>
                      <td>
