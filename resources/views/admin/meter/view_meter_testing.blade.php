...
@section('content')
  ...
  @if($data['testing_status']=='Sample Selected')
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ url('/')}}/store_testing_meters_status" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
