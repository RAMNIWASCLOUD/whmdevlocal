    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="row">
              <form action="{{ url('/')}}/s2s_upload_prepare_resend_to_supplier" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="col-md-2">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="oldpassword">Prepare Re-Send To Supplier(.csv)<span style="color:red;" >*</span></label><a href="{{url('/')}}/sample_files/file_input/s2s_damage/admin_prepare_resend_to_supplier_s2s_damaged_meter.csv" target="_blank">Download Sample File</a>
                  ...
                  <form action="{{ url('/')}}/s2s_upload_permanent_damage" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                  <div class="col-md-2">
                    <div class="box-body">
                      <div class="form-group">
                ...
                <div class="col-md-1">
                  <div class="box-body">
                    <div class="form-group" >
                      @if(Session::get('download_enabled')=='1')<a style="margin-top: 64px" class="btn btn-primary" href="{{url('/').'/export_report/s2s_repaired_meter'}}">Export(.csv)</a>@endif
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
                    ...
                    <tr>
                     ...
                     <td>
                      ...
                      <td>
                        <?php
                        $user = '';
                        if(!empty($value['s2s_sm_damaged_mark_by_id']))
                        {
                          $user = \DB::table('login_users')->where(['_id'=>new MongoId($value['s2s_sm_damaged_mark_by_id'])])->first(); 
                        } 
                        ?>
