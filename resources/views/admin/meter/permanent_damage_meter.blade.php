      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="row">
                <form action="{{ url('/')}}/upload_prepare_resend_to_supplier_from_pd" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
                   {!! csrf_field() !!}
                  <div class="col-md-4">
                    <div class="box-body">
              ...
              <div class="col-md-2">
                  <div class="box-body">
                    <div class="form-group" >
                      <input type="text" style="margin-top: 24px" class="form-control" id="search" name="search" value="{{isset($_GET['search'])? $_GET['search']: ''}}" placeholder="Enter Device ID" >
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-1">
                  <div class="box-body">
                    <div class="form-group" >
                      @if(Session::get('download_enabled')=='1')<a style="margin-top: 24px" class="btn btn-primary" href="{{url('/').'/export_report/permanent_damage_meter'}}">Export(.csv)</a>@endif
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
