                ...
                <tbody>
                  ...
                  @foreach($data as $value)
                    <tr>
                      ...
                      <td>
                        <a href="{{url('/')}}/manage_seleted_meter/{{$value['batch_id']}}" title="View">
                          <i class="fa fa-eye"></i>
                        </a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{ url('/')}}/store_testing_batch_status" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              @include('admin.layout._status_msg')
              {!! csrf_field() !!}
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <select id="reason" name="reason" class="form-control">
                        ...
                        <option value="Terminal screw issue">Terminal screw issue</option>
