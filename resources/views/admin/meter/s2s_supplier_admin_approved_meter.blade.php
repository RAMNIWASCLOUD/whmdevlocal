          ...
          <div class="box">
            ...
            <form method="GET" action="" data-parsley-validate="parsley">
                ...
                <div class="col-md-1">
                  <div class="box-body">
                    <div class="form-group" >
                      @if(Session::get('download_enabled')=='1')<a class="btn btn-primary" href="{{url('/').'/export_report/s2s_supplier_admin_approved_meter'}}">Export(.csv)</a>@endif
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
                ...
                <tbody>
                  ...
                  @foreach($data as $value)
                    <tr>
                      ...
                      <td>
                        {{$value['s2s_supplier_admin_approve_date']}}
                      </td>
                      <td>
