      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
            <!-- /.box-header -->
             <form action="{{ url('/')}}/s2s_supplier_approve_meter" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              {!! csrf_field() !!}
                <div class="row">
                  <div class="col-md-3">
                    <div class="box-body">
                      <div class="form-group">
                        <label for="oldpassword">Upload Approve Meter(.csv)<span style="color:red;" >*</span></label><a href="{{url('/')}}/sample_files/file_input/s2s_damage/supplier_approve_s2s_damaged_meter.csv" target="_blank">Download Sample File</a>
            ...
            <form method="GET" action="" data-parsley-validate="parsley">
                ...
                <div class="col-md-1">
                  <div class="box-body">
                    <div class="form-group" >
                      @if(Session::get('download_enabled')=='1')<a class="btn btn-primary" href="{{url('/').'/export_report/s2s_supplier_pending_meter'}}">Export(.csv)</a>@endif
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
