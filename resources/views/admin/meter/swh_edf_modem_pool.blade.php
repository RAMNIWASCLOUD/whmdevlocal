      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
            <!-- /.box-header -->
            <form method="GET" action="" data-parsley-validate="parsley" style="display: none;">
            ...
            <form id="form_dispatch_meter_step_1" action="{{url('/')}}/form_dispatch_meter_step_1" method="POST">
              {!! csrf_field() !!}
                ...
                <div class="col-md-1">
                  <div class="box-body">
                    <div class="form-group" >
                      <button class="btn btn-primary" type="button" onclick="select_meter()">Select Meter</button><br>
