    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
             <form action="{{ url('/')}}/upload_admin_accept_damaged_meter" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              {!! csrf_field() !!}
                <div class="row">
                  <div class="col-md-4">
                    <div class="box-body">
                      <div class="form-group">
                        <label for="oldpassword">Upload Accept Meter(.csv)<span style="color:red;" >*</span></label><a href="{{url('/')}}/sample_files/file_input/damage/admin_accept_damaged_meter.csv" target="_blank">Download Sample File</a>
                ...
                <div class="col-md-1">
                  <div class="box-body">
                    <div class="form-group" >
                      @if(Session::get('download_enabled')=='1')<a class="btn btn-primary" href="{{url('/').'/export_report/sm_to_admin_pending_acceptance_damaged_meter'}}">Export(.csv)</a>@endif
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
                  ...
                  @foreach($data as $value)
                    <tr>
                     ...
                     <td>
                      ...
                      <td>
                        <?php $user = \DB::table('login_users')->where(['_id'=>new MongoId($value['sm_damaged_mark_by_id'])])->first(); ?>
                        {{$user['warehouse_name']}}
                      </td>
                      <td>
                      ...
                      <td>
                        {{(isset($value['repaired_time']))? $value['repaired_time']:'-'}}
                      </td>
                       <td>
